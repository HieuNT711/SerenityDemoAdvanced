...
#    When she adds 'Buy some milk' to his list
#    Then 'Buy some milk' should be recorded in his list
#
#  Scenario: Adding an item to a list with other items in Cucumber
#    Given that Jane has a todo list containing Buy some milk
#    When she adds 'Buy some cereal' to her list
#    Then her todo list should contain Buy some milk,Buy some cereal
#
...
#    Given Jame register account in LiveGuru99 successfully
