...
public class ToggleAllTodos {
    ...
    public void should_be_able_to_quickly_complete_all_todos_with_page_objects() {
        ...
        james.should_see_that_that_following_items_are_marked_as_complete(
    ...
    public void should_be_able_to_toggle_status_of_all_todos_with_page_objects() {
        ...
        james.should_see_that_that_following_items_are_marked_as_active(
                "Walk the dog", "Put out the garbage");
    }

    @Test
    public void
            should_see_that_there_are_zero_items_todo_when_all_are_toggled_complete_with_page_objects() {
    ...
    @Test
    public void
            should_see_how_many_items_todo_when_all_are_toggled_to_incomplete_with_page_objects() {
